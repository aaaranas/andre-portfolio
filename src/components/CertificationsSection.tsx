...
import { Award, BarChart3, Zap, Github, ExternalLink, CheckCircle2, ShieldCheck, X } from "lucide-react";
import { Badge } from "@/components/ui/badge";

function getCertIcon(iconType: string, color: string) {
  const props = { style: { width: "22px", height: "22px", color } };
  switch (iconType) {
    case "bar-chart":
            ...
            <ScrollReveal key={cert.id} delay={idx * 0.1}>
              ...
              >
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = `${cert.badgeColor}22`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = `${cert.badgeColor}12`;
                  }}
                >
          ...
          <div className="modal-box" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "560px", padding: "32px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  <div style={{ fontSize: "11px", fontFamily: "var(--font-mono)", color: activeCert.badgeColor, textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 700 }}>
                    Official Credential
                  </div>
            ...
            <div style={{ background: "var(--bg3)", padding: "18px", borderRadius: "12px", border: "1px solid var(--border)", marginBottom: "24px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px", flexWrap: "wrap", gap: "8px" }}>
                <div>
                  ...
                  <div style={{ fontSize: "13px", fontFamily: "var(--font-mono)", color: "var(--text)", fontWeight: 700 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "13px", fontFamily: "var(--font-mono)", color: "var(--text)", fontWeight: 600 }}>
                    {activeCert.date}
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                {activeCert.skills.map((s) => (
                  <span key={s} style={{ fontSize: "11px", fontFamily: "var(--font-mono)", color: activeCert.badgeColor, background: `${activeCert.badgeColor}15`, padding: "3px 10px", borderRadius: "6px" }}>
                    {s}
                  </span>
                ))}
              </div>
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end", flexWrap: "wrap" }}>
              <button
                onClick={() => setActiveCert(null)}
                style={{ background: "var(--bg3)", border: "1px solid var(--border)", color: "var(--text)", padding: "10px 18px", borderRadius: "8px", fontFamily: "var(--font-mono)", fontSize: "12px", cursor: "pointer" }}
              >
                Close
              </button>
              <a
                ...
                rel="noreferrer"
                style={{
                  background: activeCert.badgeColor,
                  color: "#080c10",
                  padding: "10px 20px",
                  borderRadius: "8px",
                  fontWeight: 700,
