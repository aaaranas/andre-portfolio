  ...
  const resources = [
    {
      ...
      icon: BookOpen,
      description: "Deep dives on n8n agent architectures, spatial transit cleaning, and offline-first WebSocket synchronization.",
      color: "var(--accent2)",
      badge: "Writing",
    },
    {
      ...
      icon: Award,
      description: "Verified certificates in AI Engineering, Google Data Analytics, Meta Front-End, and Machine Learning.",
      color: "#4ade80",
      badge: "Credentials",
    },
  ];
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px" }}>
                    <div style={{ background: `${prof.color}15`, padding: "10px", borderRadius: "12px", display: "inline-flex" }}>
                      <IconComponent style={{ width: "24px", height: "24px", color: prof.color }} />
                    </div>
